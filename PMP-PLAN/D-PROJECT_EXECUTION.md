...
NAUFAL FIQRI BIN 
Objectives:
•	Provides the system that easy to install and can be integrated with the chatbot anytime, anywhere.
•	Provides an assistance bot capable of giving information about mental health as soon as possible.
•	
